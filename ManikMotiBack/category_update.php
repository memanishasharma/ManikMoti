            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" action="category_updateinfo.php" method="post" enctype="multipart/form-data">
                         <?php
								 include 'config.php';
								 $id= $_GET['id'];
                              ...
                              <div class="col-sm-offset-2 col-sm-8">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" name="category_name" value="<?php echo $th1[1] ?>"  class="form-control">
                                    </div>
                                  </div>

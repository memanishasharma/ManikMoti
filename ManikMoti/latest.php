...
echo '<br>';
echo '<div class="img">';
	//echo '<a href="fetchview.php?id='.$th[0].'" class="thumbnail"><img  src="data:image/jpeg;base64,'.base64_encode($th['7']).'" //width=100px height="100px" />';
echo '<a href="fetchview.php?id='.$th[0].'" ><img src="'.$th['14'].'" width="180px" height="180px" />'; 
//echo '</div>';
	echo '<br>';
	echo 'Ad Title: ';
	echo $th['5'];
